@props(['title' => config('app.name', 'GreenMile')])
...
<head>
    ...
    <meta name="description"
        content="GreenRun – Platform lari berbasis dampak lingkungan. Bergabunglah dan jadikan setiap langkahmu berarti.">
    ...
    <div class="min-h-screen flex flex-col lg:flex-row">
        ...
        <div class="auth-hero relative hidden lg:flex lg:w-1/2 xl:w-3/5 flex-col justify-between p-10 xl:p-14"
            ...
            <div class="relative z-10">
                <a href="{{ url('/') }}" class="inline-flex items-center gap-2.5">
                    <img src="{{ asset('images/greenmile_logo.png') }}" alt="GreenMile Logo"
                        class="w-9 h-9 object-cover">
                    <span class="text-white font-bold text-xl tracking-tight">GreenMile</span>
                </a>
            </div>
            ...
            <div class="relative z-10 animate-fade-in-up">
                ...
                <p class="text-white/70 text-base leading-relaxed mb-8 max-w-md">
                    Bergabunglah dengan ribuan pelari yang peduli lingkungan. Lari lebih bermakna setiap kilometer
                    menggerakkan aksi nyata untuk bumi.
                </p>
        ...
        <div class="flex flex-1 flex-col justify-center items-center px-6 py-10 sm:px-10 lg:px-12 xl:px-16"
            ...
            <div class="lg:hidden mb-8 text-center">
                <a href="{{ url('/') }}" class="inline-flex items-center gap-2.5">
                    <div class="w-9 h-9 rounded-xl flex items-center justify-center" style="background: #003F2F;">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M12 3C9 3 6.5 4.5 5 7c-.5 1-1 2.5-1 4s.5 3.5 2 5l6 5 6-5c1.5-1.5 2-3.5 2-5s-.5-3-1-4C17.5 4.5 15 3 12 3z"
                                fill="#2ECF89" opacity="0.9" />
                        </svg>
                    </div>
                    <span class="font-bold text-xl tracking-tight" style="color: #003F2F;">GreenMile</span>
                </a>
            </div>
            ...
            <p class="mt-10 text-center text-xs" style="color: #6B7280;">
                &copy; {{ date('Y') }} GreenMile. Hak cipta dilindungi.
            </p>
        </div>
    </div>
</body>
