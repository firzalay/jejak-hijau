...
<header class="flex items-center justify-between px-4 py-4 sticky top-0 z-20"
    ...
    <div>
        <div class="flex items-center gap-1.5 mb-0.5">
            ...
            <span class="text-xs font-semibold tracking-tight" style="color: #003F2F;">GreenMile</span>
        </div>
    ...
    {{-- Avatar --}}
    <a href="{{ $user->isOrganizer() ? route('organizer.profile.show') : route('profile.show') }}"
        aria-label="Lihat Profil" id="nav-profile-avatar">
