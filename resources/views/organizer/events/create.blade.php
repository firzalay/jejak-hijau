<x-app-layout title="Buat Event Baru – Jejak Hijau" :user="$user">
    <div class="px-4 py-6 max-w-3xl mx-auto space-y-6">
        ...
        {{-- Form --}}
        <form id="create-event-form" method="POST" action="{{ route('organizer.events.store') }}" class="bg-white rounded-2xl border border-gray-150 p-6 shadow-sm space-y-6" novalidate>
            @csrf
