<x-app-layout title="Edit Event – Jejak Hijau" :user="$user">
    <div class="px-4 py-6 max-w-3xl mx-auto space-y-6">
        ...
        {{-- Form --}}
        <form id="edit-event-form" method="POST" action="{{ route('organizer.events.update', $event->id) }}" class="bg-white rounded-2xl border border-gray-150 p-6 shadow-sm space-y-6" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="number" id="max_points" name="max_points" value="{{ old('max_points', $event->max_points) }}" min="1" required
