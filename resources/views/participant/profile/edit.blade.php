<x-app-layout title="Edit Profil – Jejak Hijau" :user="$user">
    <div class="px-4 py-6 max-w-xl mx-auto space-y-6 animate-fade-in">
        ...
        {{-- Form --}}
        <form id="edit-profile-form" method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="bg-white rounded-2xl border border-gray-150 p-6 shadow-sm space-y-6" novalidate>
            @csrf
            @method('PUT')
